...
public class Library {
    ...
    Member m1 = new Member("ahmed", "Lahore", 1234, "ahmedbilal", "3456",l1);
    Member m2 = new Member("ahmed", "Lahore", 1234, "ahmedbilal", "876",l1);

    // l1.members.add(m1);
    
    Book b1 = new Book("A2343F", "Java", 234,"Muhammad Talha","Ahmed Bilal");
    Book b2 = new Book("234567VD", "Python", 678,"Muhammad Zaid","Amir Hussain");
    ...
    ahmed.issueBook(l1, m1, "Python");
    m1.viewHistory();
    // ahmed.issueBook(l1, m2, "Python");
